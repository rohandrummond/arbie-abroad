...
import image from './about-us-arbie.svg'
import './About.css'
...
function About() {
    return (
        <div>
            <Header />
            <div className="about-us-container container col-xxl-10">
                <div className="row flex-lg-row-reverse align-items-center g-8 py-5">
                    <div className="col-10 col-sm-8 col-lg-6">
                        <img src={image} className="about-us-image d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" loading="lazy" />
                    </div>
                    <div className="col-lg-6">
                        <h1 className="about-us-editorial display-5 lh-1 about-us-title">Rohan and Britt here!</h1>
